...
iris <- merge(iris[,c("CODE_IRIS", "NOM_IRIS", "TYP_IRIS", "NOM_COM")], 
              df[,c("IRIS","DISP_MED19")],
...
poi$federation[is.na(poi$federation)] <- "Priv"
```
...
```{r, eval = FALSE}
library(osrm)
options(osrm.server = "http://1xx.xxx.3x.1x4:5xx0/", osrm.profile = "bike")
