...
The map below displays the location of the climbing areas in the study area (white dots), the travel-time by bike required to reach each points of the 150m regular grid (little dots colours) and the isochrones deducted from these values. 
