...
IRIS are aggregated at commune level for the map layout.
...
<!-- -->
```
-   climbing.toptope: If the articial climbing area is a wall (need a rope to climb)
-   climbing.boulder: If the artificial climbing area is dedicated to bouldering (no need of rope to climb).
-   climbing.length: Height of the wall (if adapted, for walls)
-   climbing.routes: Number of climbing routes (if adapted, for walls)
